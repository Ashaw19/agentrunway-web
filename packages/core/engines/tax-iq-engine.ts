...
const TAX_TIPS: TaxTip[] = [
  ...
  },
  {
    ...
    body: "Unlike employees who split CPP contributions with their employer, self-employed individuals pay both the employee and employer portions. For 2026, this can total over $9,200 (CPP1 max $8,460.90 + CPP2 max $832). The employer-equivalent half is deductible on your tax return, reducing your taxable income.",
