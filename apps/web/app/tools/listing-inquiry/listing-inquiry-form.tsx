    ...
    <div className="flex flex-col items-center gap-5 py-6 text-center">
      ...
      <div>
        ...
        <p className="mt-2.5 text-sm leading-relaxed text-slate-400">
          {name
            ? `Thanks, ${name.split(" ")[0]}. Your agent will follow up shortly.`
            : "Your agent will follow up shortly."}
        </p>
      </div>
      <div
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="grid grid-cols-2 gap-4">
        <Field id="li-first" label="First name" required value={firstName} onChange={setFirstName} placeholder="Jane" autoComplete="given-name" />
        <Field id="li-last" label="Last name" required value={lastName} onChange={setLastName} placeholder="Smith" autoComplete="family-name" />
      </div>

      <Field id="li-email" label="Email address" required type="email" value={email} onChange={setEmail} placeholder="jane@email.com" autoComplete="email" />
      <Field id="li-phone" label="Phone number" optional type="tel" value={phone} onChange={setPhone} placeholder="(506) 555-0100" autoComplete="tel" />
      <Field id="li-property" label="Property you're inquiring about" required value={propertyAddress} onChange={setPropertyAddress} placeholder="123 Main St, Saint John, NB" autoComplete="street-address" />
      <TextareaField id="li-message" label="Your message" optional value={message} onChange={setMessage} placeholder="When are you available to view? Any specific questions about the property?" />
        ...
        >
          ...
          <span className="relative flex items-center justify-center gap-2">
            {status === "loading" ? (
              ...
              <>Send my inquiry<ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" /></>
            )}
          </span>
        </button>
      </div>
