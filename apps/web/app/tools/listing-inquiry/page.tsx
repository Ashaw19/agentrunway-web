...
const URL = "https://agentrunway.ca/tools/listing-inquiry";

export const metadata: Metadata = {
  title: "Listing Inquiry — Agent Runway",
  description:
    "Interested in a property? Send a message to the listing agent. Powered by Agent Runway — the business platform built for Canadian real estate agents.",
  openGraph: {
    type: "website",
    url: URL,
    title: "Listing Inquiry — Agent Runway",
    description: "Send a listing inquiry. Powered by Agent Runway.",
      ...
      <main className="flex flex-1 flex-col items-center justify-start px-6 py-16 sm:py-24">
        <div className="w-full max-w-lg">
          ...
          <p className="mb-10 text-center text-base leading-relaxed text-slate-400">
            Send your details and your agent will be in touch to answer questions and arrange a showing.
          </p>
