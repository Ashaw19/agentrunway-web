...
const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    description:
      "Your personal AI advisor sees your live financial data. Ask about taxes, pace, strategy, or any platform feature — it knows your numbers and can explain anything.",
